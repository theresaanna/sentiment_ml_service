...
class SentimentModelTrainer:
    ...
    def predict(self, texts: List[str]) -> List[Dict[str, Any]]:
        ...
        if hasattr(self.pipeline.named_steps['classifier'], 'predict_proba'):
            # Transform texts first using the vectorizer
            X_transformed = self.pipeline.named_steps['vectorizer'].transform(texts)
            probabilities = self.pipeline.named_steps['classifier'].predict_proba(X_transformed)
