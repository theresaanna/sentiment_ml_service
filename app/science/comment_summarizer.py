...
class CommentSummarizer:
    ...
    def summarize_with_openai(self, comments: List[Dict], sentiment_results: Optional[Dict] = None) -> Dict:
        ...
        try:
            ...
            prompt = f"""
            Please provide an objective, balanced summary of the following YouTube video comments.
            ...
            Provide:
            1. A brief objective overview (2-3 sentences using neutral framing)
            2. Perspectives that viewers appreciated or supported
            3. Concerns or criticisms that viewers raised
            4. Main topics that generated discussion
            5. Different viewpoints or suggestions from the audience
            
            Format the response in a clear, balanced way that presents the range of viewer opinions.
            """
            
            response = openai.ChatCompletion.create(
                model="gpt-3.5-turbo",
                messages=[
                    {"role": "system", "content": "You are an objective analyst who summarizes social media comments in a neutral, balanced way. You present different viewpoints fairly without taking sides, using phrases like 'some viewers felt' and 'others argued' to maintain objectivity."},
